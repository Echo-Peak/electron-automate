...
class System extends Component {
  ...
  render() {
        ...
        <div>
          ...
          <SwipeableViews index={this.state.slideIndex} onChangeIndex={this.handleChange.bind(this)}>
            <div style={styles.slide}>
              <List>
                {this.state.system.map(e => (
                  <ListItem key={uuid()}  primaryText={e.name} onTouchTap={this.execCommand.bind(this,'system' ,e)}></ListItem>
                ))}
            </List>
            </div>
            <div style={styles.slide}>
              <List>
                {this.state.services.map(e => (
                  <ListItem  key={uuid()} primaryText={e.name} secondaryText={e.user} onTouchTap={this.execCommand.bind(this,'services' ,e)}></ListItem>
                ))}
            </List>
            </div>
            <div style={styles.slide}>
    ...
    {this.state.filtered.map((e ,index) => (
                ...
                <FlatButton  style={styles.button} secondary={true} label='kill' onTouchTap={this.execCommand.bind(this ,'processes',e)}></FlatButton>
                </div>
                ))}
            </div>
          </SwipeableViews>
